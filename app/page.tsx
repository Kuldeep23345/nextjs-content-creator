            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center lg:items-start">
              ...
              <Link href={"/feed"}>
                <Button
                  variant={"outline"}
                  size={"xl"}
                  className="rounded-full w-full sm:w-auto bg-transparent hover:bg-transparent hover:text-white"
                >
                  Explore the Feed
                </Button>
              </Link>
              ...
              <div className="space-y-4">
                {platformTabs.map((tab, index) => (
                  <Button
                    ...
                    className={` w-full justify-start h-auto p-6 bg-transparent hover:bg-transparent hover:text-white  `}
                  >
                    <div className="flex items-center gap-4">
                      ...
                      >
                        <tab.icon className="w-6 h-6 bg-transparent" />
                      </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <Link href="/feed">
              <Button
                variant="outline"
                size="xl"
                className="rounded-full w-full bg-transparent hover:bg-transparent hover:text-white border border-gray-400/80"
              >
                Explore the Feed
              </Button>
            </Link>
